...
- **Direct C# Modding for Pawn AI**: Develop custom JobGivers and ThinkNodes to implement goal-oriented military logic and behavior trees for individual pawns and squads. This replaces the need for `NPC AI Framework`.
- **Extend Toughness Skill Mod framework** to implement Fitness, Strength, and Discipline skills.
- **Integrate Dead Man's Switch AI behaviors** with custom military traits and rank structures (will be verified for LLM-agnostic implementation).
...
- **Implement AI-driven drill sergeants** (via custom C# JobGivers/ThinkNodes) who autonomously manage recruit training and evaluation.
...
- **Semi-autonomous squad behaviors** through integrated custom C# AI and Colony Survival Logic.
- **Strategic command AI** (via global C# scripts) for base-level military decision making and resource prioritization.
...
- **Dead Man's Switch Suite** - Advanced AI behaviors and military unit mechanics (to be verified for LLM-agnostic implementation).
...
- **Toughness** - Framework for custom skills (Strength, Fitness, Discipline).
